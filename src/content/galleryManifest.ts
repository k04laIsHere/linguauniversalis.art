...
export const galleryWorks: GalleryWork[] = [
  ...
  {
    id: 'meritxellrodes-orange-table',
    artist: 'Meritxell Rodes',
    titleEn: 'Flowers on an Orange Table',
    titleRu: 'Цветы на оранжевом столе',
    titleEs: 'Flores en una mesa naranja',
    src: enc('/assets/art/meritxell-work-4.jpg'),
    tags: ['meritxellrodes'],
    year: '2024',
    size: '22×27 cm',
    mediumEn: 'Oil and soft pastel on paper',
    mediumRu: 'Масляная и сухая пастель на бумаге',
    mediumEs: 'Pastel al óleo y seco sobre papel',
  },
  {
    id: 'meritxellrodes-three-cherries',
    artist: 'Meritxell Rodes',
    titleEn: 'Three Cherries',
    titleRu: 'Три вишни',
    titleEs: 'Tres cerezas',
    src: enc('/assets/art/meritxell-work-2.jpg'),
    tags: ['meritxellrodes'],
    year: '2024',
    size: '20×20 cm',
    mediumEn: 'Oil and soft pastel on paper',
  ...
  {
    id: 'meritxellrodes-autumn-kolomenskoye',
    artist: 'Meritxell Rodes',
    titleEn: 'Autumn. Kolomenskoye',
    titleRu: 'Осень. Коломенское',
    titleEs: 'Otoño. Kolomenskoye',
    src: enc('/assets/art/meritxell-work-1.jpg'),
    tags: ['meritxellrodes'],
    year: '2024',
    size: '35×50 cm',
    mediumEn: 'Oil and soft pastel on paper',
  ...
  {
    id: 'meritxellrodes-flowers',
    artist: 'Meritxell Rodes',
    titleEn: 'Flowers',
    titleRu: 'Цветы',
    titleEs: 'Flores',
    src: enc('/assets/art/meritxell-work-3.jpg'),
    tags: ['meritxellrodes'],
    year: '2024',
    size: '24×35 cm',
    mediumEn: 'Oil and soft pastel on paper',
