...
export const es: I18nDict = {
  ...
  cave: {
    ...
    manifesto: [
      'El arte es la primera palabra de la humanidad: un lenguaje silencioso y eterno que precede a toda frontera y lengua hablada.',
      'La creación no es la búsqueda de lo "nuevo", sino un ritual para recuperar lo "real", reconectando el alma con el cosmos.',
      'Más allá de la fragmentación moderna, el Arte de la Creación actúa como un puente, entrelazando los hilos de nuestra conciencia colectiva.',
      'Lo prehistórico y lo futurista son los dos extremos de un mismo camino: mirar hacia nuestros orígenes es descubrir el plano de nuestro futuro.',
      'Hace milenios, comenzamos una conversación en estos muros. Un diálogo que nunca se ha detenido.',
    ],
